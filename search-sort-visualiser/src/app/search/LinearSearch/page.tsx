      ...
      <div className="grid grid-cols-2 gap-4 pt-32 px-2">
        <div className="outline outline-2 outline-slate-100 p-5">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              It can be used on various data structures, including arrays,
        ...
        <div className="outline outline-2 outline-slate-100 p-5">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              The worst-case complexity is O(n), which means that the search
              time increases linearly with the size of the list or array.
            </li>
            <li>Not efficient for searching in sorted arrays or lists.</li>
            <li>
              It may have to examine the list of elements even if the target
              value is found early in the list, which can be inefficient,
              especially when searching for a single element.
            </li>
          </ul>
        </div>
      </div>
